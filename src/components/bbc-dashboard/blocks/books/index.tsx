  ...
  return (
    <div className="bbc-reg">
      ...
      <div className="bbc-reg-lede">
        <p>
          Здесь лежат копии книг компании. Книга приезжает из Google один раз, и
          дальше её заполняют прямо тут — формой или строкой в таблице. Дашборд
          умеет считать по этой копии: переключатель <b>Google / Книга</b> в
          шапке выбирает, откуда взяты цифры.
        </p>
        <p className="bbc-reg-hint">
          Обратно в Google приложение не пишет никогда — правки остаются здесь.
        </p>
      </div>
